...
class BaseCar():
    ...
    def run_test_drive_1(self, forward_secs: int = 3, sleep_secs: int = 1, backward_secs: int = 3, speed: int = 40):
    ...
    def run_test_drive_2(self, forward_secs: int = 1, circle_secs: int = 8,
    ...
    def shake_front_wheels(self, t2w=.2):
