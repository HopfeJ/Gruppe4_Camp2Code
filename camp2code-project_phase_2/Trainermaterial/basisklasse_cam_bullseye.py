...
class Camera(object):
    ...
    """
    def __init__(self, buffersize : int=1, skip_frame : int=2, 
                 height : int=None, width : int=None, hflip : bool=True, vflip=True, colorspace : str=None) -> None:
        ...
        self.__config = self.__PiCamera.create_still_configuration(main={"size": (self.__width, self.__height), "format":"RGB888"},
                                                              transform=libcamera.Transform(hflip=int(self.__hflip), vflip=int(self.__vflip)),
