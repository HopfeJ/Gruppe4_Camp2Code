...
class BackWheels(object):
    ...
    def fahrparcours1(self) -> None:

        
        self.speed = 50
        self.forward()
        print(f'Geschwindigkeit vorwärts: {self.speed}')
        time.sleep(3)
        ...
        self.speed = 50
        self.backward()
        print(f'Geschwindigkeit rückwerts: {self.speed}')
        time.sleep(3)
